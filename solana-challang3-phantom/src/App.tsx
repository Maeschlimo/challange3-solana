...
//useState Hook = possible to add states to components, useEffect Hook= performe side effects in functioncomponents (refresh page)
import {useEffect , useState } from "react";

// create types= create type of variable
